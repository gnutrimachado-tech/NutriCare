...
const styles = StyleSheet.create({
  ...
  topLeft: { width: "63%", paddingTop: 16.67 },
  ...
  ccHeadTxt: { fontSize: 8.8, color: MUTED, fontWeight: 700 },
  ...
  ccColParamText: { fontSize: 9.6, color: INK },
  ccColRef: { width: "36%", fontSize: 7.6, color: MUTED, lineHeight: 1.12 },
  ccColRes: { width: "18%", fontSize: 9.6, color: INK },
  ccColEval: { width: "20%" },
  ...
  pillNeutral: { color: MUTED, fontSize: 9 },
